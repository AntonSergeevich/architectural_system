...
(function () {
  ...
  // --- Условия объекта -----------------------------------------------------
  // Площадь, помещения, месяцы стройки и сложность — такие же входные данные,
  // как и блоки. Менять их и не видеть цену бессмысленно: площадь правят ровно
  // затем, чтобы узнать свою сумму, а не чужую. Раньше цифры пересчитывались
  // только от блоков, и конструктор молчал в ответ на главное действие.

  if (form) {
    // Ввод с клавиатуры даёт «input», выбор из списка — «change»;
