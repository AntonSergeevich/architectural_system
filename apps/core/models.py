...
class SiteSettings(models.Model):
    ...
    reply_hours = models.PositiveSmallIntegerField(
        ...
        help_text="Считается в рабочем времени, а не в календарном. "
                  "Девять часов — это один рабочий день с 10:00 до 19:00, "
                  "то есть те самые «сутки», которые обещает регламент. "
                  "При 24 рабочих часах страница пообещает среду на вопрос, "
                  "заданный вечером пятницы, — и разойдётся с регламентом, "
                  "напечатанным рядом на той же странице",
    )
